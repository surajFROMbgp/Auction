...
import sk from '../ImagesOur/sk.jpeg';
import ak from '../ImagesOur/Ak.jpeg';
import ask from '../ImagesOur/Ashk.jpeg';
...
{/* <p>Nonprofit Auction Software</p> */}
  ...
  <div className="row abtclssection">
    ...
    <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
      <div className="box">
        <img src={ask} className="img-fluid" alt="" />
    ...
    <div className="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
      <div className="box">
        <img src={ak} className="img-fluid" alt="" />
        <h3>Abhinandan Kumar</h3>
        <p>UI desginer</p>
      </div>
    </div>
